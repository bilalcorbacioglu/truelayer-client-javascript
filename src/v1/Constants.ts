...
export class Constants {
    ...
    public static readonly AUTH_SANDBOX_URL: string = "https://auth.truelayer-sandbox.com";
    public static readonly API_SANDBOX_URL: string = "https://api.truelayer-sandbox.com";
